    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderMastersOrderDetail", x => x.OrderMasterId);
                    table.ForeignKey(
                        name: "FK_OrderMastersOrderDetail_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_OrderMastersOrderDetail_OrderMasterId",
                        column: x => x.OrderMasterId,
                        principalTable: "OrderMastersOrderDetail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderMastersOrderDetail_CustomerId",
                table: "OrderMastersOrderDetail",
                column: "CustomerId");
        }
